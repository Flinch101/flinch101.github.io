...
setTimeout(() => {
    ...
    <body>
        ...
        <div class="container">
            <!-- ADD ---------------------------------- -->
            <div class="ad"> 
                <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5838016460172798${url}" crossorigin="anonymous"></script>
            </div>
            <!-- HEADER ---------------------------------- -->
            <header>
                <div class="container-dentro">
                    <div class="up">
                        <div class="logo">
                            <img src="https://raw.githubusercontent.com/Flinch101/base-de-datos/main/iconos/icono-white.png${url}" alt="Venta de Articulos icono">
                        </div>
                        <div class="buscador">
                            <div class="input">
    ...
    setTimeout(() => {
        let todo = document.querySelector('.todo');
        todo.classList.toggle('todo-display');
        todo.textContent = '';
